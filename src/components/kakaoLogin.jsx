...
const KakaoLogin = () => {
    // 카카오 개발자 앱 키 선언
    const REST_API_KEY = "4028a54927c5f52787a0926046740b70"; // RestAPI 키
    const REDIRECT_URI = "http://localhost:3000/LoginPage"; // redirect 주소
        ...
        (async () => {
            try {
                const res = await axios
                    ...
                    .get(
                        `http://ec2-43-200-90-45.ap-northeast-2.compute.amazonaws.com:8080/api/oauth/token?code=${code}`
                    )
                    // 백엔드 쪽에서 보내준 응답 확인
                    .then((response) => {
            ...
            try {
                const res = await axios
                    ...
                    .get(
                        "http://ec2-43-200-90-45.ap-northeast-2.compute.amazonaws.com:8080/api/user/mypage",
                        {
    ...
    return (
        <>
            <div className="KaKaoBtn">
                <a href={KAKAO_AUTH_URI}><img src="img/kakao_login_medium_narrow.png" alt="카카오로 시작하기" /></a>
            </div>
        </>
    );
};
